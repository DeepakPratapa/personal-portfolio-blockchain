...
async function main() {
  ...
  console.log("✅ ProjectVerification deployed to:", verificationAddress);
    ...
    // Populate skills
    await portfolio.addSkillCategory("languages", ['JavaScript', 'Go', 'Python', 'C++', 'C', 'C#', 'PHP', 'Bash', 'TypeScript', 'Solidity']);
    await portfolio.addSkillCategory("frameworks", ['ReactJS', 'Node.js', 'Django', '.NET', 'Flask', 'Hardhat', 'Truffle']);
    await portfolio.addSkillCategory("databases", ['MySQL', 'MongoDB', 'PostgreSQL', 'SQLite']);
    await portfolio.addSkillCategory("cloud", ['AWS', 'Firebase']);
    await portfolio.addSkillCategory("devops", ['Docker', 'Git', 'GitHub Actions', 'CI/CD Pipelines']);
    await portfolio.addSkillCategory("security", ['Wireshark', 'Nmap', 'Metasploit', 'Kali Linux', 'Burp Suite', 'Suricata', 'OPNsense', 'Nessus', 'Security Onion', 'Volatility', 'Autopsy', 'Sleuth Kit', 'Sysinternals Suite', 'FTK Imager', 'OpenVAS', 'Qualys', 'Alien Vault OTX', 'VirusTotal']);
    await portfolio.addSkillCategory("expertise", ['Secure Coding', 'API Design', 'Vulnerability Assessment', 'Incident Response', 'Penetration Testing', 'Network Defense', 'Threat Intelligence', 'Malware Analysis', 'Risk Management', 'Smart Contract Development', 'Cryptographic Hash Verification']);
    await portfolio.addSkillCategory("blockchain", ['Ethereum', 'Polygon', 'Smart Contracts', 'Solidity', 'Web3.js', 'Ethers.js', 'DeFi', 'Cryptographic Verification', 'Blockchain Security']);
    await portfolio.addSkillCategory("other", ['REST APIs', 'Blockchain Development', 'Cryptography', 'Code Verification Systems']);

    // Populate experience as an array of strings
    await portfolio.addExperience('Application Developer Intern', 'Precistat IT Solutions', 'Jun 2022 -- Jul 2022', [
    ...
    await portfolio.addExperience('Graduate Research Assistant', 'University of Central Oklahoma', 'Feb 2024 -- Apr 2024', [
    ...
    await portfolio.addExperience('Graduate Teaching Assistant', 'University of Central Oklahoma', 'Jan 2025 -- May 2025', [
    ...
    const projects = [
       {
        ...
        repo: 'https://github.com/DeepakPratapa/blockchain-verified-portfolio',
    ...
    for (const proj of projects) {
        await portfolio.addProject(proj.title, proj.description, proj.repo, proj.caseStudy);
    }
    
    // Populate research
    await portfolio.addResearch('Secure Data Encryption for ATM Transactions', 'Sep 2022', [
    ...
    ], 'https://www.irjet.net/archives/V9/i9/IRJET-V9I9127.pdf');
    
    // Populate certifications
    
    await portfolio.addCertification('Cyber Operations', 'Dec 2024', 'University of Central Oklahoma', 'https://www.credly.com/badges/db433472-9a95-4f15-b35d-2e8504613636/public_url', [
    ...
    await portfolio.addCertification('Incident Analysis and Response', 'May 2024', 'University of Central Oklahoma', 'https://www.credly.com/badges/3f8b10b4-9373-4b61-b081-ec5142ed1792/public_url', [
    ...
    await portfolio.addCertification('JavaScript for Front End Web', 'Dec 2023', 'University of Central Oklahoma', 'https://www.credly.com/badges/68301bfc-6518-4c96-9f9c-6f2514f53b8f/public_url', [
      'Designed front-end modules leveraging modular and event-driven design, debugging, and modern web standards.'
    ]);
    await portfolio.addCertification('Web Application Technologies and Django', 'Mar 2022', 'University of Michigan (Coursera)', 'https://www.coursera.org/account/accomplishments/verify/6HDVCAJXZ6PN', [
      'Strengthened backend development for secure web applications using Django, REST APIs, Python, and industry best practices.'
    ]);
    
    // Populate education
    await portfolio.addEducation('Masters in Computer Science', 'University of Central Oklahoma', '2023--2025', '3.72');
    await portfolio.addEducation('B.Tech. in Computer Science and Engineering, Specialization in Information Security', 'Vellore Institute Of Technology', '2019--2023', '7.94');

    // Populate achievements
    await portfolio.addAchievement('President\'s Honor Roll, University of Central Oklahoma', 'Fall 2023', [
    ...
    await portfolio.addAcademicFocus(
